...
hintNoBindings:SetText("Drag a spell, item or macro here to bind it")
...
do	-- click binding
	...
	local mouseFocusOverlay = CreateFrame("Frame", nil, UIParent, BackdropTemplateMixin and "BackdropTemplate")
